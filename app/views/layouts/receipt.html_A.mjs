<!-- https://mjml.io/try-it-live/r1FxCj1FI->
<mjml>
  <mj-body background-color="#ccd3e0">
    ...
    <mj-section background-color="#A8192E" padding-bottom="0px" padding-top="0">
      <mj-column width="100%">
        <mj-text align="center" font-size="13px" color="#FFF" font-family="Ubuntu, Helvetica, Arial, sans-serif" padding-left="25px" padding-right="25px" padding-bottom="18px" padding-top="28px">Hello
      ...
      <!-- Start Section-->
      <mj-column>
        <mj-text align="center" color="#FFF" font-size="15px" font-family="Ubuntu, Helvetica, Arial, sans-serif" padding-left="25px" padding-right="25px" padding-bottom="0px"><strong>Giftcard Number</strong></mj-text>
    ...
    <mj-section background-color="#A8192E" padding-bottom="15px">
      <mj-column>
    ...
    <mj-section background-color="#A8192E" padding-bottom="5px" padding-top="0">
      <mj-column width="100%">
        <mj-divider border-color="#ffffff" border-width="2px" border-style="solid" padding-left="20px" padding-right="20px" padding-bottom="0px" padding-top="0"></mj-divider>
